...
namespace ShootCube.World.Chunk
{
    public class XFlat : IFlat
    {
            ...
            Matrix transformation = default(Matrix))
        {
            ...
            if (transformation == default(Matrix))
                transformation = Matrix.Identity;

            Vertices[0] = new VPTVDeclaration(world + Vector3.Transform(new Vector3(x, y, z), transformation), 
            ...
            Vertices[1] = new VPTVDeclaration(world + Vector3.Transform(new Vector3(x + scale_x, y, z), transformation), 
            ...
            Vertices[2] = new VPTVDeclaration(world + Vector3.Transform(new Vector3(x + scale_x, y + scale_y, z), transformation), 
            ...
            Vertices[3] = new VPTVDeclaration(world + Vector3.Transform(new Vector3(x, y + scale_y, z), transformation), 
