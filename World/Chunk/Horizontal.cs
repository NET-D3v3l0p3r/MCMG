...
namespace ShootCube.World.Chunk
{
    public class Horizontal : IFlat
    {
        ...
        public Horizontal(Vector3 world, int x, int y, int z, byte id, float value)
        {
            ...
            Vertices[2] = new VPTVDeclaration(world + new Vector3(x + 1, y, z + 1), new Vector2(ChunkManager.RatioX + ChunkManager.TextureAtlasCoordinates[id].X, ChunkManager.TextureAtlasCoordinates[id].Y + 0), value);
            Vertices[3] = new VPTVDeclaration(world + new Vector3(x, y, z + 1), new Vector2(0 + ChunkManager.TextureAtlasCoordinates[id].X, ChunkManager.TextureAtlasCoordinates[id].Y + 0), value);
